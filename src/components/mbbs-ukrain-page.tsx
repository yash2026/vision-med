    ...
    <MbbsUkrainPageLayout.Root className="mt-20">
      <MbbsUkrainPageLayout.LeftSection>
        ...
        <Paragraph className="mt-3">
          ...
          universities. The MD house will not charge any additional fee for
        ...
        <Paragraph className="mt-3">
          The MD House is one of the best MBBS career counselors for Indian
          ...
          before their NEET scores are announced. Through MD House, Indian
        ...
        <ContentHeading className="mt-3 text-red-500">
          Apply for MBBS in Ukraine Admission 2024-25 Through The MD House
          Today!
        </ContentHeading>
        <Paragraph className="mt-3">
            ...
            data={[
              ...
              <>
                ...
                <Link
                  ...
                  href={"mailto:info@themdhouse.com"}
                >
                  info@themdhouse.com
                </Link>
              </>,
