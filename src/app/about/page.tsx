        ...
        <AboutPageLayout.Root className="text-sm mt-20 gap-10">
          <AboutPageLayout.LeftSection className="flex flex-col gap-4">
            <ContentHeading className="text-[25px]">
              Some reasons which makes The Vision Med most trusted:
            </ContentHeading>

            <p className="leading-7">
              The Vision Med has been identified as the most trusted career
              partner by thousands of satisfied students and parents. Following
              are the reasons that gives The Vision Med an edge over others
            </p>
            <p className="leading-7">
              The Vision Med is having a team of most seasons, experienced,
              tried and tested career counselors.
            </p>
            <p className="leading-7">
              The Vision Med has the exceptionally good know – how of
              immigration laws, visa laws, large base of foreign partners for
              providing our students post landing to placement services.
            </p>
            <p className="leading-7">
              The Vision Med never hides any facts and truths.
            </p>
            <p className="leading-7">
              The Vision Med never charges any hidden expenses.
            </p>
            <p className="leading-7">
              The Vision Med provides very detailed and transparent information
              and advice.
            </p>
            <p className="leading-7">
              The Vision Med has excellent student- parent support system.
            </p>
            <p className="leading-7">
              The Vision Med was the first and oldest consultant started sending
              students to pursue
            </p>
            <p className="leading-7">
              The Vision Med and associates have successfully placed 1000+
